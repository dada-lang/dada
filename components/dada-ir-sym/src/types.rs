...
use crate::{env::EnvLike, scope::{NameResolution, NameResolutionSym, Resolve}, ir::symbol::{FromVar}, ir::types::{SymGenericTerm, SymPerm, SymPlace, SymGenericKind, SymTy}, prelude::Symbol, CheckInEnv};
