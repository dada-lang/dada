...
- [Welcome](./welcome.md)
- [Goals](./goals.md)
- [Tutorial: Dynamic Dada](./dyn_tutorial.md)
  - [Hello, Dada!](./dyn_tutorial/hello.md)
  ...
  - [Permissions](./dyn_tutorial/permissions.md)
    ...
    - [Friends don't let friends mutate shared data](./dyn_tutorial/sharing_xor_mutation.md)
...
- [Tutorial](./old_tutorial.md)
  - [Dada basics](./old_tutorial/basics.md)
...
- [Sharing permissions](./dyn_tutorial/share.md)
  - [Sharing xor mutation](./dyn_tutorial/sharing_xor_mutation.md)
- [Combining sharing and leasing](./dyn_tutorial/shared_leases.md)
- [Atomic storage and blocks](./dyn_tutorial/atomic.md)
